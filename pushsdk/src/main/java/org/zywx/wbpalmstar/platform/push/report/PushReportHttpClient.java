...
import org.zywx.wbpalmstar.platform.push.certificates.Http;
...
public class PushReportHttpClient {
    ...
    public static String newPushOpenByPostData(String url, Context mCtx, String tenantId, String softToken) {
        ...
        try {
            ...
            String appid = PushReportUtility.getAppID(mCtx);
            if (!TextUtils.isEmpty(tenantId)) {
                appid = tenantId + ":" + appid;
            }
            String appkey = PushReportUtility.getAppKey(mCtx);
            ...
            jsonObject.put("tenantMark", PushReportUtility.getTenantAccount(mCtx));
